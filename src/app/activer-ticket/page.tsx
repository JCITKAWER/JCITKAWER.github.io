...
export default function ActiverTicketPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0A1130] selection:bg-jci-blue/30 selection:text-white overflow-x-hidden flex flex-col items-center justify-start md:justify-center py-24 md:py-32">
      <MeshGradient variant="glow" />
      <FloatingBlobs />

      <main className="relative z-10 w-full max-w-xl px-10">
        <motion.div 

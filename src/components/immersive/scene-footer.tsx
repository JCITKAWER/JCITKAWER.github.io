...
export function SceneFooter() {
  return (
    <footer id="contact" className="relative overflow-hidden bg-[#0A1130] border-t border-white/5">
      {/* Background Enhancements */}
      <div className="absolute inset-x-0 bottom-0 top-1/2 bg-[radial-gradient(ellipse_at_bottom,rgba(0,151,215,0.08),transparent_60%)] pointer-events-none" />
      ...
      <div className="container-pro pt-20 pb-12 md:pt-32 md:pb-16 grid grid-cols-1 md:grid-cols-3 gap-8 items-start relative z-10">
        {/* Brand */}
        ...
        <div className="text-center md:text-right space-y-4">
          ...
          <div className="space-y-1">
            <p className="text-white/35 text-[10px] tracking-[0.3em] uppercase font-bold">
              © {new Date().getFullYear()} JCI ELFEJJA BESSETINE
            </p>
